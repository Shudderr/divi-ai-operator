# Divi 5 Audit Master Index
Use this index to determine which specific audit module to load. Do NOT load all files at once.

| Task | Audit Module to Use |
| :--- | :--- |
| **Colors, Fonts, Spacing, UI** | `01_UX_VISUAL.md` |
| **LCP, JS Bloat, JSON structure** | `02_PERFORMANCE.md` |
